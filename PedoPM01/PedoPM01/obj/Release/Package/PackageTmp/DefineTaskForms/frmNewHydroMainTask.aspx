<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmNewHydroMainTask.aspx.cs" Inherits="PedoPM01.DefineTaskForms.frmNewHydroMainTask" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="breadLine">
        <ul class="breadcrumb">
            ...
            <li class="active">Hydro Project Work Plan</li>
        </ul>
    </div>
    <%--</div>--%>
    <!-- workplace -->
            ...
            <div class="span12">
                ...
                <div class="block-fluid">
                    ...
                    <div class="row-form clearfix">
                        ...
                        <div class="span4">
                            Project:<asp:DropDownList ID="ddlProject" runat="server" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlProject_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                    ...
                    <div class="row-form clearfix">
                        ...
                        <div class="row-form clearfix">
                            ...
                            <div class="span3">
                                <asp:DropDownList ID="ddlHydro" runat="server" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlHydro_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                        </div>
                        ...
                        <div class="row-form clearfix" id="divStartDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbStartDate" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender_StartDate" runat="server" TargetControlID="tbStartDate" Format="dd/MM/yyyy" />
                            </div>
                        </div>
                        ...
                        <div class="row-form clearfix" id="divFinishDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbDeadline" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <div class="row-form clearfix" id="divDesignDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbDesignDate" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <div class="row-form clearfix" id="divDesignFinishDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbDesignFinishDate" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <div class="row-form clearfix" id="divConstructDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbConstructDate" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <div class="row-form clearfix" id="divConstructFinsihDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbConstructFinsihDate" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                      ...
                      <%--  <div class="row-form clearfix" id="divOrderDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbOrderDate" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender_OrderDate" runat="server" Format="dd/MM/yyyy" TargetControlID="tbOrderDate" />
                            </div>
                        </div>
                        ...
                        <div class="row-form clearfix" id="divOrderFinishDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbOrderFinishDate" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender_OrderFinishDate" runat="server" Format="dd/MM/yyyy" TargetControlID="tbOrderFinishDate" />
                            </div>
                        </div>
                        ...
                        <div class="row-form clearfix" id="divShipmentDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbShipmentDate" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <div class="row-form clearfix" id="divShipmentFinishDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbShipmentFinishDate" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <div class="row-form clearfix" id="divInstallationDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbInstallationDate" runat="server" placeholder="Select Date" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <div class="row-form clearfix" id="divInstallationFinishDate" runat="server">
                            ...
                            <div class="row span3">
                                <asp:TextBox ID="tbInstallationFinishDate" placeholder="Select Date" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
