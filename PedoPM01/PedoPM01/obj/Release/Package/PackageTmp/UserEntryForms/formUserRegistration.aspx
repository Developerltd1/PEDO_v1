<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="formUserRegistration.aspx.cs" Inherits="PedoPM01.UserEntryForms.formUserRegistration" %>
 ...
 <%--<div style="margin-top:-40px">--%>    
             ...
             <div class="breadLine">
                     <ul class="breadcrumb">                <%--<li><a href="#">Project Director</a> <span class="divider">></span></li>--%>                
                        <li class="active">User's Registration</li>
                    </ul>
            </div>
    <%--</div>--%>
    <!-- workplace -->
            ...
            <div class="span4">
                    ...
                    <div class="block-fluid">                        
                        ...
                        <div class="row-form clearfix">
                            <div>Project:</div>
                            <div class="span10">
                                <asp:ListBox runat="server" ID="listProject" SelectionMode="multiple"></asp:ListBox> 
                            <%--<asp:DropDownList ID="cbProject" runat="server"></asp:DropDownList></div>--%>
                        </div>
                            </div>
